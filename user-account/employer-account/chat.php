	...
	<div class="main-container">
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="row">
					<div class="col-xl-5 col-lg-5 col-md-5 col-sm-12 mb-30 bg-light p-2">
						<h5 class="h5 mt-2">Contacts</h5>
						<div class="pd-20 card-box height-50-p mt-3 p-0">
						        ...
						        border rounded p-2 mb-1">
												...
												<?php } else { ?>
													<div class="d-flex align-items-center">
														<img src="<?= $chatWith['p_p'] ?>" class="chat-img me-3 rounded-circle">
